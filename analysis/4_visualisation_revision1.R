...
#                   4. Plots and visualisation (after revision)             #
#                                                                           #
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
windows(pointsize=24, width= 6000, height= 3000)
par(mfrow = c(1,2), family= "TNR")

generate_bubble_plot(res_totalnbl, dataTotalN_bl, xlimMin = 0, xlimMax = 1250, ylimMax=8, moderator= "totaln_bl", 
                     xTicks =seq(0, 1250, by= 50), plotLabel= "a) Sample Size and Scale", legendTextSize = 0.6,
...
generate_bubble_plot(res_year, data, xlimMin = 1970, xlimMax = 2025, ylimMax=8, moderator = "year", 
                     xTicks= seq(1970, 2025, by= 5), plotLabel = "b) Year and Scale", legendTextSize = 0.6,
